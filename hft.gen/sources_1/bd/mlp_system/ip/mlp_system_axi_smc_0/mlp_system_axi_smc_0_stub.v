...
// Command     : write_verilog -force -mode synth_stub -rename_top mlp_system_axi_smc_0 -prefix
//               mlp_system_axi_smc_0_ mlp_system_axi_smc_0_stub.v
...
(* CHECK_LICENSE_TYPE = "mlp_system_axi_smc_0,bd_90d9,{}" *) (* CORE_GENERATION_INFO = "mlp_system_axi_smc_0,bd_90d9,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=28,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "bd_90d9,Vivado 2025.2" *) 
module mlp_system_axi_smc_0(aclk, aresetn, S00_AXI_awid, S00_AXI_awaddr, 
